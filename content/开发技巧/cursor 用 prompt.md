...
15. Give the answers with Chinese
...
这个 prompt 适用于不熟悉某种技术栈或者概念的初学者, 特点是会在解释代码的同时, 给出下一步的学习建议

来源于 https://www.youtube.com/watch?v=YozWFvkUMcQ&t=1s&ab_channel=MckayWrigley , 在原有基础上添加了 `Give the answers with Chinese`, 表示使用中文回复
...
6. Give the answers with Chinese
...
适用于实际开发中的各种场景, 特点是 claude 回复的过程生成思考过程, 似乎效果不错, 很智能

来源于 https://github.com/richards199999/Thinking-Claude, 在原有基础上添加了 `Give the answers with Chinese`, 表示使用中文回复